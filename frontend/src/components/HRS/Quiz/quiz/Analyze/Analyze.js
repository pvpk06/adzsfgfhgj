          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell><strong>Attempt Number</strong></TableCell> {/* New column for attempt number */}
            ...
            <TableBody>
              {quizData.responses.map((data, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>{data.attempt_number}</TableCell> {/* Displaying attempt number */}
                  <TableCell>
        ...
        <div style={{ position: 'relative', padding: '20px' }}>
          ...
          {selectedResponse ? (
            <div>
              ...
              <p><strong>Attempt Number:</strong> {selectedResponse.attempt_number}</p> {/* Displaying attempt number */}
              <hr />
              <div>
